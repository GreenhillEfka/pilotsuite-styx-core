...
**PilotSuite Core** — Das Gehirn + Stimme der PilotSuite-Plattform. Home Assistant Add-on mit Brain Graph, RAG Chat, Mood Engine, Zone Automation und bundled Ollama LLM. Aktuelle Core/Add-on-Release-Linie: **v15.0.4**. **Dieses Repo ist nicht die HACS-Integration.**
