...
> **Versioning rule:** This manual is authoritative for the **Core/Add-on** lane only. Do **not** infer the current **HA/HACS** release from this file. Verify HA/HACS truth in `pilotsuite-styx-ha` manifests/tags/releases. Current Core/Add-on release line here: **15.2.7**.
