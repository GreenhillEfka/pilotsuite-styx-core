...
## Exact next step
- No release yet.
- If governance wants a real cut next, the correct next visible move is: `mache v15.2.0` in the group thread, then 5-minute wait + release lock + fresh validation rerun.
