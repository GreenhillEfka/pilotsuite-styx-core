...
> **Versioning rule:** This document tracks the **Core/Add-on** API surface. Do **not** infer the current **HA/HACS** release from this file. Verify HA/HACS truth in `pilotsuite-styx-ha` manifests/tags/releases. Current Core/Add-on release line here: **15.2.4**.
