...
class ZonePresenceHoldNotificationSummary:
    ...
    def __post_init__(self):
        """Compute has_changes based on revision comparison."""
        object.__setattr__(self, 'has_changes', self.since_revision is None or self.notification_revision > self.since_revision)
