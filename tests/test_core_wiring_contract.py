...
def test_core_setup_keeps_events_ingest_unprefixed_in_blueprint_registry() -> None:
    core_setup = (CORE_APP_ROOT / "copilot_core" / "core_setup.py").read_text(encoding="utf-8")
